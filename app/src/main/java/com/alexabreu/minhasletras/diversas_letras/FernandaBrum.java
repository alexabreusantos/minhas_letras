package com.alexabreu.minhasletras.diversas_letras;
...
public class FernandaBrum {
    ...
    public static String nomeImpossivel = "Impossível te esquecer";
    public static String letraImpossivel = "Amigo é muito mais\n" +
    ...
    public static String nomeApenasUmToque = "Apenas um Toque";
    public static String letraApenasUmToque = "Com olhar apaixonado\n" +
            "Quero te dizer palavras\n" +
            "Que expressam a vontade\n" +
            "Do meu coração\n" +
            "A intimidade da adoração\n" +
            "\n" +
            "Como um filho \n" +
            "Eu quero um abraço\n" +
